...
*   **تبدیل تاریخ به میلادی (Gregorian Conversion):** تبدیل خودکار تاریخ‌های شمسی به میلادی و ذخیره در ستون `Gregorian_Date`.
*   **استخراج زمان دقیق:** استخراج زمان انتشار خبر علاوه بر تاریخ.
...
استخراج اخبار بر اساس شناسه (ID) صفحه.
این اسکرپر زمان خبر را نیز استخراج و به میلادی تبدیل می‌کند.
...
*   `Gregorian_Date`: تاریخ میلادی (تبدیل شده از شمسی)
*   `Time`: زمان انتشار به شمسی
